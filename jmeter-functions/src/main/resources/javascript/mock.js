!function (t, e) {
    ...
    return function (t) {
        ...
        var r, a = n(1), o = n(3), u = n(5), i = n(20), l = n(23), c = n(25);
	...
	*/
        var s = {
            Handler: a, Random: u, Util: o, XHR: r, RE: i, toJSONSchema: l, valid: c, heredoc: o.heredoc, setup: function (t) {
                return r.setup(t)
            }, _mocked: {}
        };
        s.version = "1.0.1-beta3", r && (r.Mock = s), s.mock = function (t, e, n) {
            return 1 === arguments.length ? a.gen(t) : (2 === arguments.length && (n = e, e = void 0), r && (window.XMLHttpRequest = r), s._mocked[t + (e || "")] = {
                rurl: t,
                rtype: e,
                template: n
            }, s)
        ...
        var Constant = __webpack_require__(2), Util = __webpack_require__(3), Parser = __webpack_require__(4), Random = __webpack_require__(5),
            RE = __webpack_require__(20), Handler = {extend: Util.extend};
        Handler.gen = function (t, e, n) {
            ...
            _all: function () {
                ...
                try {
                    ...
                    if (u && "object" == typeof u && t in u && n !== u[t]) return u[t] = Handler.gen(u[t], t, {
                        currentContext: o,
        ...
        n.extend = function () {
            ...
            for (1 === l && (u = this, i = 0); i < l; i++) if (t = arguments[i]) for (e in t) r = u[e], a = t[e], u !== a && void 0 !== a && (n.isArray(a) || n.isObject(a) ? (n.isArray(a) && (o = r && n.isArray(r) ? r : []), n.isObject(a) && (o = r && n.isObject(r) ? r : {}), u[e] = n.extend(o, a)) : u[e] = a);
            return u
        }, n.each = function (t, e, n) {
            var r, a;
            if ("number" === this.type(t)) for (r = 0; r < t; r++) e(r, r); else if (t.length === +t.length) for (r = 0; r < t.length && e.call(n, t[r], r, t) !== !1; r++) ; else for (a in t) if (e.call(n, t[a], a, t) === !1) break
        }, n.type = function (t) {
        ...
        t.exports = {
            parse: function (t) {
                ...
                var e = (t || "").match(r.RE_KEY), n = e && e[3] && e[3].match(r.RE_RANGE), o = n && n[1] && parseInt(n[1], 10),
                    ...
                    l = e && e[4] && e[4].match(r.RE_RANGE), c = l && l[1] && parseInt(l[1], 10), s = l && l[2] && parseInt(l[2], 10),
        ...
        (function (t) {
            t.exports = {
                ...
                dataImage: function (e, n) {
                    ...
                    var u = parseInt(e[0], 10), i = parseInt(e[1], 10), l = this._brandColors[this.pick(this._brandNames())], c = "#FFF", s = 14,
                        h = "sans-serif";
        ...
        t.exports = {
            rgb2hsl: function (t) {
                var e, n, r, a = t[0] / 255, o = t[1] / 255, u = t[2] / 255, i = Math.min(a, o, u), l = Math.max(a, o, u), c = l - i;
                ...
                var e, n, r, a = t[0], o = t[1], u = t[2], i = Math.min(a, o, u), l = Math.max(a, o, u), c = l - i;
                ...
                var e = t[0] / 60, n = t[1] / 100, r = t[2] / 100, a = Math.floor(e) % 6, o = e - Math.floor(e), u = 255 * r * (1 - n),
                    i = 255 * r * (1 - n * o), l = 255 * r * (1 - n * (1 - o));
                switch (r *= 255, a) {
                    case 0:
                        return [r, l, u];
                    case 1:
        ...
        t.exports = {
            capitalize: function (t) {
                ...
                var n = t.options, r = n.context.templatePath.join("."), a = t.cache[r] = t.cache[r] || {index: 0, array: e};
        ...
        var g = function () {
            ...
            function g(t) {
                ...
                function I() {
                    var e, n, r, a;
                    return e = Zn, 40 === t.charCodeAt(Zn) ? (n = ie, Zn++) : (n = null, 0 === ar && b(le)), null !== n ? (r = z(), null === r && (r = U(), null === r && (r = N(), null === r && (r = j()))), null !== r ? (41 === t.charCodeAt(Zn) ? (a = ce, Zn++) : (a = null, 0 === ar && b(se)), null !== a ? (Qn = e, n = he(r), null === n ? (Zn = e, e = n) : e = n) : (Zn = e, e = kt)) : (Zn = e, e = kt)) : (Zn = e, e = kt), e
                }
                ...
                function z() {
                    var e, n, r;
                    return e = Zn, t.substr(Zn, 2) === ve ? (n = ve, Zn += 2) : (n = null, 0 === ar && b(ge)), null !== n ? (r = C(), null !== r ? (Qn = e, n = xe(r), null === n ? (Zn = e, e = n) : e = n) : (Zn = e, e = kt)) : (Zn = e, e = kt), e
                }
                ...
                function W() {
                    var t;
                    return t = Z(), null === t && (t = pt(), null === t && (t = et(), null === t && (t = nt(), null === t && (t = rt(), null === t && (t = at(), null === t && (t = ot(), null === t && (t = ut(), null === t && (t = it(), null === t && (t = lt(), null === t && (t = ct(), null === t && (t = st(), null === t && (t = ht(), null === t && (t = dt(), null === t && (t = mt(), null === t && (t = vt(), null === t && (t = gt(), null === t && (t = xt()))))))))))))))))), t
                }
                ...
                function V() {
                    var t;
                    return t = Q(), null === t && (t = tt(), null === t && (t = pt(), null === t && (t = et(), null === t && (t = nt(), null === t && (t = rt(), null === t && (t = at(), null === t && (t = ot(), null === t && (t = ut(), null === t && (t = it(), null === t && (t = lt(), null === t && (t = ct(), null === t && (t = st(), null === t && (t = ht(), null === t && (t = ft(), null === t && (t = dt(), null === t && (t = mt(), null === t && (t = vt(), null === t && (t = gt(), null === t && (t = xt()))))))))))))))))))), t
                }
                ...
                var yt, bt = arguments.length > 1 ? arguments[1] : {}, wt = {regexp: C}, Ct = C, kt = null, Et = "", Rt = "|", At = '"|"',
                    _t = function (t, e) {
        ...
        var a = n(3), o = n(5), u = {extend: a.extend}, i = r(97, 122), l = r(65, 90), c = r(48, 57),
            s = r(32, 47) + r(58, 64) + r(91, 96) + r(123, 126), h = r(32, 126), p = " \f\n\r\t\v \u2028\u2029", f = {
                "\\w": i + l + c + "_", "\\W": s.replace("_", ""), "\\s": p, "\\S": function () {
        ...
        var a = n(2), o = n(3), u = n(23), i = {
            diff: function (t, e, n) {
                ...
                if (t.properties) {
                    ...
                    for (var c = 0; c < i.length; c++) r.push.apply(r, this.diff(function () {
                        var e;
        ...
        function a() {
            ...
            var n = function () {
                var t = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, e = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,
                    n = location.href, r = e.exec(n.toLowerCase()) || [];
                return t.test(r[1])
            }();
        ...
        var l = {UNSENT: 0, OPENED: 1, HEADERS_RECEIVED: 2, LOADING: 3, DONE: 4},
            c = "readystatechange loadstart progress abort error load timeout loadend".split(" "), s = "timeout withCredentials".split(" "),
            h = "readyState responseURL status statusText responseType response responseText responseXML".split(" "), p = {
                100: "Continue",
        ...
        }, i.extend(r, l), i.extend(r.prototype, l), r.prototype.mock = !0, r.prototype.match = !1, i.extend(r.prototype, {
            open: function (t, e, n, u, l) {
                function p(t) {
                    for (var e = 0; e < h.length; e++) try {
                        f[h[e]] = m[h[e]]
                    } catch (t) {
                    }
